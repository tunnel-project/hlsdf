...
async def main():
    ...
    try:
        ...
        vless_vmess_configs1 = await get_configs('https://raw.githubusercontent.com/V2RAYCONFIGSPOOL/V2RAY_SUB/main/V2RAY_SUB.txt')
        vless_vmess_configs2 = await get_configs('https://rentry.co/DailyV2ry/raw')
        ss_configs = get_shadowsocks_configs()

        # Combine and modify all configs
        all_configs = vless_vmess_configs1 + vless_vmess_configs2 + ss_configs
